...
class SmartLTXSequencer(LTXVAddGuide):
    @classmethod
    def define_schema(cls):
        inputs = [
            ...
            io.Image.Input("multi_input", tooltip="Batched images from SmartMultiImageLoader"),
        ]
        ...
        return io.Schema(
            node_id="SmartLTXSequencer",
            display_name="Smart LTX Sequencer",
